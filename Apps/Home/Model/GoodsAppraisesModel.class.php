...
class GoodsAppraisesModel extends BaseModel {
	...
	public function addGoodsAppraises($obj){
		...
		$goodsScore = 5; //$goodsScore>5?5:$goodsScore;
		$goodsScore = 5; //$goodsScore<1?1:$goodsScore;
		$timeScore = (int)I("timeScore");
		$timeScore = 5; //$timeScore>5?5:$timeScore;
		$timeScore = 5; //$timeScore<1?1:$timeScore;
		$serviceScore = (int)I("serviceScore");
		$serviceScore = 5; //$serviceScore>5?5:$serviceScore;
		$serviceScore = 5; //$serviceScore<1?1:$serviceScore;
		//检查订单是否有效
