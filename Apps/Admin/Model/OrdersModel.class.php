	 ...
	 */
     ...
     public function queryByPage(){
        $shopName = WSTAddslashes(I('shopName'));
	 	...
	 	$sql = "select o.orderId,o.orderNo,o.totalMoney,o.realTotalMoney,o.orderStatus,o.deliverMoney,o.payType,o.createTime,s.shopName,o.userName,u.loginName,o.useScore,o.coupId from __PREFIX__orders o
	 	         left join __PREFIX__shops s on o.shopId=s.shopId left join inte_users u on o.userId=u.userId where o.orderFlag=1 ";
