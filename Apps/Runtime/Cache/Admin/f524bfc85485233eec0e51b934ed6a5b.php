           ...
           <tr>
             ...
             <table width='100%'>
                ...
                <tr style='border-top:1px solid #dddddd'>
                   <td rowspan='5' valign='top' width='100'><label><input type='checkbox' value='ddgl' class='chk' onclick='javascript:checkModel(this)'/>订单管理</label></td>
                ...
                <tr>
                   <td><label><input type='checkbox' class='chk ddgl ddts' value='ddts' onclick='javascript:checkModel(this)'/>订单投诉</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant ddgl ddts' id='ddts_00' value='ddts_00'/>投诉列表</label>
                   <label><input type='checkbox' class='chk grant ddgl ddts' id='ddts_04' value='ddts_04'/>投诉处理</label>
                   </td>
                </tr>
                <tr>
                ...
                <tr>
                   <td><label><input type='checkbox' class='chk ddgl js' value='js' onclick='javascript:checkModel(this)'/>结算列表</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant ddgl js' id='js_00' value='js_00'/>结算列表</label>
                   <label><input type='checkbox' class='chk grant ddgl js' id='js_04' value='js_04'/>确认结算</label>
                   </td>
                </tr>
                <tr style='border-top:1px solid #dddddd'>
                ...
                <tr>
                   <td width='90'><label><input type='checkbox' class='chk bbtj' value='dttj' onclick='javascript:checkModel(this)'/>订单统计</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant bbtj dttj' id='dttj_00' value='dttj_00'/>订单统计</label>
                   </td>
                </tr>
                <tr style='border-top:1px solid #dddddd'>
                   <td rowspan='3' valign='top' width='100'><label><input type='checkbox' class='chk' value='dpgl' onclick='javascript:checkModel(this)'/>商家管理</label></td>
                   <td width='90' colspan='2'><label><input type='checkbox' class='chk grant dpgl' id='dpgl_00' value='dpgl_00' onclick='javascript:checkModel(this)'/>查看商家管理栏目</label></td>
                </tr>
                <tr> 
                   <td width='90'><label><input type='checkbox' class='chk dpgl' value='dplb' onclick='javascript:checkModel(this)'/>商家列表</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant dpgl dplb' id='dplb_00' value='dplb_00'/>商家列表</label>
                   <label><input type='checkbox' class='chk grant dpgl dplb' id='dplb_01' value='dplb_01'/>新增商家</label>
                   <label><input type='checkbox' class='chk grant dpgl dplb' id='dplb_02' value='dplb_02'/>修改商家</label>
                   <label><input type='checkbox' class='chk grant dpgl dplb' id='dplb_03' value='dplb_03'/>删除商家</label>
                   </td>
                </tr>
                <tr>
                   <td><label><input type='checkbox' class='chk dpgl'  value='dpsh' onclick='javascript:checkModel(this)'/>商家审核</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant dpgl dpsh' id='dpsh_00' value='dpsh_00'/>商家列表</label>
                   </td>
                </tr>
                <tr style='border-top:1px solid #dddddd'>
                ...
                <tr>
                   <td ><label><input type='checkbox' class='chk scsz' value='ggwzgl' onclick='javascript:checkModel(this)'/>广告位置</label></td>
                   <td>
                   <label><input type='checkbox' class='chk grant scsz ggwzgl' id='ggwzgl_00' value='ggwzgl_00'/>广告位置列表</label>
                   <label><input type='checkbox' class='chk grant scsz ggwzgl' id='ggwzgl_01' value='ggwzgl_01'/>新增广告位置</label>
                   <label><input type='checkbox' class='chk grant scsz ggwzgl' id='ggwzgl_02' value='ggwzgl_02'/>修改广告位置</label>
                   <label><input type='checkbox' class='chk grant scsz ggwzgl' id='ggwzgl_03' value='ggwzgl_03'/>删除广告位置</label>
                   </td>
                </tr>
                <tr>
                ...
                <tr>
                   <td ><label><input type='checkbox' class='chk scsz' value='kdgl' onclick='javascript:checkModel(this)'/>快递管理</label></td>
                   <td>
                      <label><input type='checkbox' class='chk grant scsz kdgl' id='kdgl_00' value='kdgl_00'/>快递列表</label>
                      <label><input type='checkbox' class='chk grant scsz kdgl' id='kdgl_01' value='kdgl_01'/>新增快递</label>
                      <label><input type='checkbox' class='chk grant scsz kdgl' id='kdgl_02' value='kdgl_02'/>编辑快递</label>
                      <label><input type='checkbox' class='chk grant scsz kdgl' id='kdgl_03' value='kdgl_03'/>删除快递</label>
                   </td>
                </tr>

                <tr>
                   <td ><label><input type='checkbox' class='chk scsz' value='sjfx' onclick='javascript:checkModel(this)'/>三级分销配置</label></td>
                   <td>
                      <label><input type='checkbox' class='chk grant scsz sjfx' id='sjfx_00' value='sjfx_00'/>分润列表</label>
                      <label><input type='checkbox' class='chk grant scsz sjfx' id='sjfx_01' value='sjfx_01'/>一级分润</label>
                      <label><input type='checkbox' class='chk grant scsz sjfx' id='sjfx_02' value='sjfx_02'/>二级分润</label>
                      <label><input type='checkbox' class='chk grant scsz sjfx' id='sjfx_03' value='sjfx_03'/>三级分润</label>
                   </td>
                </tr>

                <tr>
                   <td ><label><input type='checkbox' class='chk scsz' value='coupon' onclick='javascript:checkModel(this)'/>代金券管理</label></td>
                   <td>
                      <label><input type='checkbox' class='chk grant scsz coupon' id='coupon_00' value='coupon_00'/>代金券列表</label>
                      <label><input type='checkbox' class='chk grant scsz coupon' id='coupon_01' value='coupon_01'/>新增代金券</label>
                      <label><input type='checkbox' class='chk grant scsz coupon' id='coupon_02' value='coupon_02'/>修改代金券</label>
                      <label><input type='checkbox' class='chk grant scsz coupon' id='coupon_03' value='coupon_03'/>删除代金券</label>
                   </td>
                </tr>

                <tr>
                   <td ><label><input type='checkbox' class='chk scsz' value='yjfk' onclick='javascript:checkModel(this)'/>意见反馈</label></td>
                   <td>
                      <label><input type='checkbox' class='chk grant scsz yjfk' id='yjfk_00' value='yjfk_00'/>反馈列表</label>
                   </td>
                </tr>
