        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
               <td><?php echo ($i); ?></td>
               <td><!--<a href="<?php echo U('Home/Shops/toShopHome',array('shopId'=>$vo['shopId']));?>" target='_blank'>--><?php echo ($vo['shopName']); ?><!--/a--></td>
               <td><?php echo ($vo['shopSn']); ?>&nbsp;</td>
               <td><?php echo ($vo['userName']); ?>&nbsp;</td>
                 <td><?php if($vo['isSelf'] == 1 ): ?><span class='label label-success'>是</span><?php elseif($vo['isSelf'] == 0): ?><span class='label label-warning'>否</span><?php endif; ?></td>
