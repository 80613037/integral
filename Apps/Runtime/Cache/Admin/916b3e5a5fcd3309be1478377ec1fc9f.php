                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Goods/index', array('score'=>1));?>" target='pageContent'>积分商城商品</a></li>
                                <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Goods/index', array('miaos'=>1));?>" target='pageContent'>限时秒杀商品</a></li>
                                <?php } ?>
                                <?php if(in_array('splb_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Goods/index', array('pintuan'=>1));?>" target='pageContent'>拼团商品</a></li>
                                <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo U('Admin/Shops/toEdit');?>" target='pageContent' >添加商家</a></li>
                                <?php } ?>
                                <?php if(in_array('dplb_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Shops/index');?>" target='pageContent' >商家列表</a></li>
					            <?php } ?>
                                <?php if(in_array('dpsh_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/Shops/queryPeddingByPage');?>" target='pageContent' >商家审核</a></li>
					            <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <?php if(in_array('coupon_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/coupon/index');?>" target='pageContent'>代金券管理</a></li>
                                <?php } ?>

                                <?php if(in_array('sjfx_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Index/setSjfenxiao');?>" target='pageContent'>分销配置</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
					            ...
					            <?php } ?>
					            <?php if(in_array('ggwzgl_00',$WST_STAFF['grant'])){ ?>
					            <li><a href="<?php echo U('Admin/AdPositions/index');?>" target='pageContent'>广告位置</a></li>
					            <?php } ?>
					            ...
					            <?php } ?>
                                <?php if(in_array('kdgl_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/transport/index');?>" target='pageContent'>快递管理</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>

                        <?php if(in_array('yjfk_00',$WST_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="pages/mailbox.html">
                                <span> 意见反馈</span>
                            </a>
                            <ul class="treeview-menu">
                                <?php if(in_array('yjfk_00',$WST_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/Users/feedback');?>" target='pageContent' >反馈列表</a></li>
                                <?php } ?>
                            </ul>
                        </li>
                        <?php } ?>
