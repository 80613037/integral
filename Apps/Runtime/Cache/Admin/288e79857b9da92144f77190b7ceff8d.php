<?php if (!defined('THINK_PATH')) exit();?><meta charset="utf-8">
   ...
   function edit(){
	   ...
	   $.post("<?php echo U('Admin/Orders/refund');?>",params,function(data,textStatus){
			var json = WST.toJson(data);
			if(json.status=='1'){
				Plugins.setWaitTipsMsg({ content:'操作成功',timeout:1000,callback:function(){
					   location.href="<?php echo U('Admin/Orders/queryRefundByPage');?>";
				}});
       ...
       <form name="myform" method="post" id="myform">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             ...
             <td>订单总金额：<font color='red'>￥<?php echo ($object['totalMoney']+$object['deliverMoney']); ?></font>&nbsp;(商品总金额：￥<?php echo ($object['totalMoney']); ?> + 运费：￥<?php echo ($object['deliverMoney']); ?>)  </td>
           </tr>
           <tr>
