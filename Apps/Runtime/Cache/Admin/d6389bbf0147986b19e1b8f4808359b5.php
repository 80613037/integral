...
<html lang="zh-cn">
   ...
   function edit(){
     ...
     params.isShow = $('input[name="isShow"]:checked').val();
	   ...
	   params.isFloor = $('input[name="isFloor"]:checked').val();
   ...
   <body class="wst-page">
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             <th align='right'>推荐楼层<font color='red'>*</font>：</th>
             <td>
             <label>
             <input type='radio' id='isFloor1' value='1' name='isFloor' <?php if($object['isFloor'] ==1 ): ?>checked<?php endif; ?>/>是
             </label>
             <label>
             <input type='radio' id='isFloor0' value='0' name='isFloor' <?php if($object['isFloor'] ==0 ): ?>checked<?php endif; ?>/>否
             </label>
             </td>
           </tr>
