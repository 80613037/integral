...
<html lang="zh-cn">
  ...
  <button type="submit" class="btn btn-primary glyphicon glyphicon-search">查询</button> 
       ...
       <div class='wst-body'>
        ...
        <?php } ?>
            <label style="float:right;margin-right:100px; color:#fff;"><a href="<?php echo U('Home/Goods/toEdit/',array('umark'=>'toEditGoods'));?>" target='_blank'>新增平台自营商品</a></label>
        </div>
        <table class="table table-hover table-striped table-bordered wst-list">
           <thead>
             <tr>
               ...
               <th width='10'>商品名称</th>
               <th width='60'>商品编号</th>
                 <?php if($score == 1): ?><th width='40'>所需积分</th>
                 <?php else: ?>
                     <th width='40'>价格</th><?php endif; ?>
               <th width='100'>商户</th>
               <th width='100'>分类</th>
               <?php if($pintuan == 1): ?><th width='100'>已参团人数</th>
                   <th width='100'>所需参团人数</th>
                   <th width='100'>结束时间</th>
                   <th width='25'>推荐</th>
               <?php elseif($miaos == 1): ?>
                   <th width='100'>秒杀时间段</th>
                   <th width='25'>推荐</th>
               <?php elseif($score == 1): ?>
                   <th width='25'>推荐</th>
                   <th width='25'>精品</th>
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $i = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
               ...
               <?php if($vo['isScore'] == 1): ?><td><?php echo ($vo['exchangeScore']); ?>&nbsp 积分</td>
               <?php else: ?>
                   <td><?php echo ($vo['shopPrice']); ?>&nbsp;</td><?php endif; ?>
               <td><a href="<?php echo U('Admin/Goods/index',array('shopName'=>$vo['shopName']));?>"><?php echo ($vo['shopName']); ?></a>&nbsp;</td>
               <td><?php echo ($vo['catName']); ?>&nbsp;</td>
               <?php if($pintuan == 1): ?><td><?php echo ($vo['XXXX']); ?></td>
               ...
               <?php elseif($miaos == 1): ?>
                   <td><?php if($vo['ismiaoshatime'] == 12): ?>12:00-15:30<?php elseif($vo['ismiaoshatime'] == 16): ?>16:00-19:30<?php elseif($vo['ismiaoshatime'] == 20): ?>20:00-11:30<?php endif; ?></td>
                   <td>
                       <?php if($vo['isAdminRecom']==1 ): ?><span class='label label-success'>推荐</span><?php endif; ?>
                   </td>
               <?php else: ?>
                   ...
                   <?php if($score != 1): if($vo['isScore'] == 1 ): ?><td>积分兑换</td><?php elseif($vo['isMiaosha'] == 1): ?><td>限时秒杀</td><?php elseif($vo['ispintuan'] == 1): ?><td>拼团商品</td><?php else: ?><td>普通商品</td><?php endif; endif; endif; ?>
               <td>
