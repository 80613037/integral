...
<html lang="zh-cn">
   ...
   $(function () {
	   ...
	   $("#areaKey").formValidator({onShow:"",onFocus:"请输入归类字母",onCorrect:"输入正确"}).regexValidator({
	       regExp:"letter",dataType:"enum",onError:"只能输入字母"
		});
   });
   function edit(){
	   var params = {};
   ...
   <body class="wst-page">
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             <th align='right'>归类字母<font color='red'>*</font>：</th>
             <td>
             <input type='text' id='areaKey' class="form-control wst-ipt" value='<?php echo ($object["areaKey"]); ?>' style='width:80px' maxLength='1'/>
             </td>
           </tr>
           <tr>
